...
if(is_numeric($id))
{
    ...
    {
        $tarea=$task->fetch_array(MYSQLI_ASSOC);
    }
    else
    {
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Añadir Sub Tarea de -> <?=$tarea['name']?></h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0">
                                ...
                                <?php 
                                $task=new task(new Connexion);
                                $task->setparent($tarea['pk_task']);
                                $task=$task->getAllByParent();
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form-insert-child" action="<?=RUTA?>process.php/proyectos/tarea/child/insert/" method="POST">
                                <div class="form-group">
                                    <label>Nombre <span class="text-danger"></span></label>
                                    <input class="form-control" type="text" name="tarea_insert_name">
                                    <input class="form-control" type="hidden" name="tarea_insert_parent" value="<?=$tarea['pk_task']?>">
                                </div>
                               <div class="row">
                                <div class="col-sm-6">
                                <div class="form-group">
            ...
            <div class="modal custom-modal fade" id="edit_holiday" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form-edit-child" action="<?=RUTA?>process.php/proyectos/tarea/update/" method="POST">
                            <div class="form-group">
                                    <label>Nombre <span class="text-danger"></span></label>
							...
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										...
										<div class="col-6">
                                        <form id="form-delete-child" method="POST" action="<?=RUTA?>process.php/proyectos/tarea/delete/">
