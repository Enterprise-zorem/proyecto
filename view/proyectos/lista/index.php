                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <div class="view-icons">
                                <a href="<?=RUTA?>proyectos" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                                <a href="<?=RUTA?>proyectos/lista/" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="team-members text-nowrap">
                                                <li>
                                                    <a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="<?=RUTA_RES?>assets/img/profiles/avatar-02.jpg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" title="Richard Miles" data-toggle="tooltip"><img alt="" src="<?=RUTA_RES?>assets/img/profiles/avatar-09.jpg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" title="John Smith" data-toggle="tooltip"><img alt="" src="<?=RUTA_RES?>assets/img/profiles/avatar-10.jpg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" title="Mike Litorus" data-toggle="tooltip"><img alt="" src="<?=RUTA_RES?>assets/img/profiles/avatar-05.jpg"></a>
                                                </li>
